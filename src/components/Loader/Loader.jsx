...
export function LoaderCenter() {
  ...
  return (
    <div className="text-align-center" style={{textAlign: "-webkit-center"}}>
...
export function LoaderTable() {
  ...
  return (
    <div>
      <PuffLoader loading={loading} css={override} size={40} />
    </div>
  );
}
  ...
  return (
    <div className="loader-body-without-Bg">
      <div align="center" className="fond">
        <svg className="svg-calLoader" xmlns="http://www.w3.org/2000/svg" width={100} height={100}>
